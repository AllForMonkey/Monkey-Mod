...
import com.afm.AfmMod.objects.blocks.item.ItemBlockVariants;
import com.afm.AfmMod.util.handlers.EnumHandler;
import com.afm.AfmMod.util.interfaces.IHasModel;
import com.afm.AfmMod.util.interfaces.IMetaName;
...
public class BlockOres extends Block implements IHasModel, IMetaName 
{
	...
	public BlockOres(String name, String dimension)
	{
		...
		setDefaultState(this.blockState.getBaseState().withProperty(VARIANT, EnumHandler.EnumType.AFM));
